    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={dynamicStyles.sectionText}>
            - Personal Information: We may collect your email address if you contact us
            for support.{"\n"}
            - Usage Data: Information such as device type, operating system, and
            interactions with the App to improve user experience.{"\n"}
            - Local Storage Data: Your learning progress and preferences are stored
            locally on your device and are not transmitted to external servers.
          </Text>

          <Text style={dynamicStyles.sectionTitle}>3. How We Use Your Information</Text>
          <Text style={dynamicStyles.sectionText}>
            We use the collected information to improve and personalize your experience
            with the App, analyze usage trends, and provide support.
          </Text>

          <Text style={dynamicStyles.sectionTitle}>4. Data Sharing and Disclosure</Text>
          <Text style={dynamicStyles.sectionText}>
            We do not sell, trade, or rent your personal data. Your learning progress is
            stored locally and not shared with any third parties.
          </Text>

          <Text style={dynamicStyles.sectionTitle}>5. Third-Party Services</Text>
          <Text style={dynamicStyles.sectionText}>
            Our App may include third-party tools such as analytics services or
            advertisements. These third parties may collect data according to their
          ...
          <Text style={dynamicStyles.sectionText}>
            You have the right to access, update, or delete your stored data within the
            App and disable data tracking via your device settings.
          </Text>
