// WordsScreenWithDrawer.tsx - Screen component for displaying words grouped by letter with drawer gesture
...
// WordsScreenWithDrawer component
export default function WordsScreenWithDrawer({
    level: staticLevel,
    ...
    useEffect(() => {
        // Log current level
        console.log(`Current Level in WordsScreenWithDrawer: ${level}, Platform: ${Platform.OS}`);
